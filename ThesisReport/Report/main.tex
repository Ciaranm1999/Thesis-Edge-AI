...
\title{On-Device Learning for Post-Harvest Mould Risk Detection: Comparing AIfES, TinyOL, and TensorFlow Lite Micro on ESP32 Sensor Nodes}  % Title of your thesis
\author{Ciaran Maher}  % Student name
\supervisor{Ali Ghaffarinejad / Bryan Williams}
% \cosupervisor{Name co-supervisor (Uncomment this line if there is no co-supervisor)}
\courseyear{2025/2026}  % Year of your thesis
\makeglossaries
