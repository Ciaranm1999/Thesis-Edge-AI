...
\textbf{MQ3 sensor selection.} The MQ3 was selected at the design stage for its low cost, wide availability, established calibration characteristics for ethanol detection, and compatibility with 3.3\,V operation. Its high current draw (\SI{103.3}{\milli\ampere} per node) was not known prior to PPK2 measurement --- resistive heater sensors of this type are not typically characterised for energy efficiency in the datasheet, and their power consumption at operating voltage is not prominently specified. The PPK2 experiments conducted as part of this thesis revealed the magnitude of the energy problem, which motivated the MEMS replacement analysis. Had the energy implications been known at design time, an alternative sensor would have been considered from the outset. This reinforces the value of systematic energy profiling at an early stage of embedded system design.
